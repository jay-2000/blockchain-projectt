module.controller("chatWindowController", [
    ...
    function (
        ...
        if (typeof web3 !== "undefined") {
            ...
            let getMessagePromise = messageFactory.getMessagesForRoom(
                vm.chatRoom
            );
            ...
            vm.setMessagesForRoom = (roomName, messages) =>
                (vm.messages[roomName] = messages);
            ...
            vm.send = function () {
                if (vm.chatMessage) {
                    ...
                    let sendMessagePromise = messageFactory.sendMessage(
                        vm.chatRoom,
                        vm.chatMessage
                    );
                    ...
                    sendMessagePromise.then(
                        function (result) {
                            ...
                            $mdToast.show(
                                $mdToast
                                    .simple()
                                    .textContent(
                                        "Message successfully sent, please wait for it to be included in the blockchain"
                                    )
                                    .position("top right")
                                    .hideDelay(3000)
                            );
                        ...
                        function (err) {
                            ...
                            if (
                                ...
                                errorMessage =
                                    "You have rejected the message transaction";
                            } else {
                                errorMessage =
